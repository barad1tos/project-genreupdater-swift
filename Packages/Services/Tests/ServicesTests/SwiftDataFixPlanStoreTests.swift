...
@Suite("SwiftDataFixPlanStore")
struct SwiftDataFixPlanStoreTests {
    ...
    func garbageConfigurationBlobThrowsCorruptedField() async throws {
        ...
        let store = SwiftDataFixPlanStore(modelContainer: container)
    ...
    private func makeStore() throws -> SwiftDataFixPlanStore {
        try SwiftDataFixPlanStore(modelContainer: makeContainer())
    }
