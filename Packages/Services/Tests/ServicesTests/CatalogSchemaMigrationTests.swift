...
struct CatalogSchemaMigrationTests {
    ...
    private static let catalogSchemaChecksum = "/qyt58upDblhzWNsI3W93TPH90bEKOW2aOeQqd06ywo="
    ...
    func pinsCatalogSchema() throws {
        try withTemporaryStore { storeURL in
            ...
            #expect(try storeChecksum(at: storeURL) == Self.catalogSchemaChecksum)
    ...
    @Test("V8 stores migrate to V9 without losing pending effects")
