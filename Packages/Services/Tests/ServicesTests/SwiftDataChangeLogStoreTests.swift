...
@Suite("SwiftDataChangeLogStore — CRUD operations")
struct SwiftDataChangeLogStoreTests {
    private func makeStore() throws -> SwiftDataChangeLogStore {
        let container = try ModelContainerFactory.createInMemory()
        return SwiftDataChangeLogStore(modelContainer: container)
    }
